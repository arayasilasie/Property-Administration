<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RMTN.aspx.cs" Inherits="PropertyAdmin.RMTN" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="overflow: auto; padding: 5px;">
                        ...
                        <asp:Panel ID="PanelSearch3" runat="server">
                            <fieldset style="border: 1px solid #FDBF12;">
                                ...
                                <div id="Div2" class="form" style="float: left; margin-bottom: 10px;">
                                    ...
                                    <div class="controlContainer" style="margin-top: 10px; margin-left">
                                        <div class="leftControl">
                                            <asp:Label ID="Label22" runat="server" Text=" Transferred Date"></asp:Label>
                                        </div>
                                        <div class="rightControl">
                                            <asp:TextBox ID="txtSTransferredDate" runat="server" ValidationGroup="search" Width="65px"></asp:TextBox>
                                            <asp:CalendarExtender ID="txtSRecievede_CalendarExtender" runat="server" Enabled="True"
                                                TargetControlID="txtSTransferredDate">
                                            </asp:CalendarExtender>
                                            -
                                            <asp:TextBox ID="txtSTransferredDate2" runat="server" ValidationGroup="search" Width="65px"></asp:TextBox>
                                            <asp:CalendarExtender ID="txtSTransferredDate2_CalendarExtender" runat="server" Enabled="True"
                                                TargetControlID="txtSTransferredDate2">
                                            </asp:CalendarExtender>
                                            <asp:CalendarExtender ID="txtStxtSRecievedDate2_CalendarExtender" runat="server"
                                                Enabled="True" TargetControlID="txtSTransferredDate">
                                            </asp:CalendarExtender>
                                            <asp:CompareValidator ID="Cv12" runat="server" ControlToValidate="txtSTransferredDate"
                                            ...
                                            <asp:CompareValidator ID="Cv13" runat="server" ControlToValidate="txtSTransferredDate2"
                                                Display="None" ErrorMessage="Please enter date only." ForeColor="#CC3300" Operator="DataTypeCheck"
                                                Type="Date" ValidationGroup="search"></asp:CompareValidator>
                                            <asp:ValidatorCalloutExtender ID="Cv13_ValidatorCalloutExtender" runat="server" Enabled="True"
                                                TargetControlID="Cv13">
                                            </asp:ValidatorCalloutExtender>
                                            <asp:CompareValidator ID="Cv14" runat="server" ControlToCompare="txtSTransferredDate"
                                                ControlToValidate="txtSTransferredDate2" Display="None" ErrorMessage="Date shouldn't be less than the start date"
                                ...
                                <div style="clear: both; margin: 1px;">
                                    ...
                                    <div style="padding-top: 5px;">
                                        <asp:GridView ID="grvTM" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333"
                                            GridLines="None" PageSize="5" AutoGenerateColumns="False" DataKeyNames="ID" OnPageIndexChanging="grvTM_PageIndexChanging"
                                            OnSelectedIndexChanged="grvTM_SelectedIndexChanged" OnRowDataBound="grvTM_RowDataBound">
                                            <EmptyDataTemplate>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="RMTNNo">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRMTNNo" Text='<%# Eval("RMTNNo") %>' runat="server"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="RecievedBy">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRecievedBy" Text='<%# Eval("TransferedTo") %>' runat="server"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="RMID" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRMID" Text='<%# Eval("RMID") %>' runat="server"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="RMStatus" Visible="false">
                                                    <ItemTemplate>
                                                ...
                                                <asp:HyperLinkField DataNavigateUrlFields="ID,FAIVID" HeaderText="RMRN" DataNavigateUrlFormatString="RMRN.aspx?TMID={0}&FAIVID={1}"
                                                    DataTextField="RMTNNo" NavigateUrl="~/RMRN.aspx" />
                                            </Columns>
        ...
        <div class="titleSub2">
            <asp:Label ID="Label6" runat="server" Text=" Returned Materials Transfer Note"></asp:Label></div>
        <div id="MainForm">
            <div>
                <div id="LeftForm" class="form2">
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        <div class="leftControl">
                            <asp:Label ID="Label3" runat="server" Text="RMTNNo"></asp:Label>
                        </div>
                        <div class="rightControl">
                            <asp:TextBox ID="txtRMTNNo" runat="server" ValidationGroup="save">
                            </asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtRMTNNo"
                                Display="Dynamic" ErrorMessage="*" ForeColor="#CC3300" ValidationGroup="save"></asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CVs" runat="server" ControlToValidate="txtRMTNNo" Display="None"
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        <div class="leftControl">
                            <asp:Label ID="Label15" runat="server" Text="Returned By"></asp:Label>
                        </div>
                        <div class="rightControl">
                            <asp:TextBox ID="txtReturnedBy" runat="server" Enabled="False"></asp:TextBox>
                        </div>
                    </div>
                    <%--  --%>
                    <div class="controlContainer" style="margin-top: 10px">
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        <div class="leftControl">
                            <asp:Label ID="Label12" runat="server" Text="Transferred By"></asp:Label>
                        </div>
                        <div class="rightControl">
                            <asp:TextBox ID="txtTransferredBy" runat="server" ValidationGroup="save">
                            </asp:TextBox>
                            <asp:AutoCompleteExtender ID="AutoCompleteExtender1t" runat="server" DelimiterCharacters=""
                                Enabled="True" MinimumPrefixLength="1" ServiceMethod="GetEmployees" ServicePath=""
                                TargetControlID="txtTransferredBy" UseContextKey="True">
                            </asp:AutoCompleteExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTransferredBy"
                                Display="Dynamic" ErrorMessage="*" ForeColor="#CC3300" ValidationGroup="save">
                            </asp:RequiredFieldValidator>
                        </div>
                    </div>
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        ...
                        <div class="rightControl">
                            <asp:TextBox ID="txtTransferredDate" runat="server" ValidationGroup="save">
                            </asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtendert1" runat="server" Enabled="True" TargetControlID="txtTransferredDate">
                            </asp:CalendarExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatort2" runat="server" ControlToValidate="txtTransferredDate"
                                Display="Dynamic" ErrorMessage="*" ForeColor="#CC3300" ValidationGroup="save">
                            </asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="Cv9" runat="server" ControlToValidate="txtTransferredDate"
                                Display="None" ErrorMessage="Please enter date only." ForeColor="#CC3300" Operator="DataTypeCheck"
                ...
                <div id="RightForm" class="form2">
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        <div class="leftControl">
                            <asp:Label ID="Label7" runat="server" Text="Transferred To"></asp:Label>
                        </div>
                        <div class="rightControl">
                            <asp:TextBox ID="txtTransferedTo" runat="server" ValidationGroup="save">
                            </asp:TextBox>
                            <asp:AutoCompleteExtender ID="txtTransferedTo_AutoCompleteExtender" runat="server"
                                DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1" ServiceMethod="GetEmployees"
                                ServicePath="" TargetControlID="txtTransferedTo" UseContextKey="True">
                            </asp:AutoCompleteExtender>
                            <asp:RequiredFieldValidator ID="TransferedToValidator7" runat="server" ControlToValidate="txtTransferedTo"
                                Display="Dynamic" ErrorMessage="*" ForeColor="#CC3300" ValidationGroup="save">
                            </asp:RequiredFieldValidator>
                        </div>
                    </div>
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        <div class="leftControl">
                            <asp:Label ID="Label8" runat="server" Text="Recieved Date "></asp:Label>
                        </div>
                        <div class="rightControl">
