<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="BinCard.aspx.cs" Inherits="PropertyAdmin.BinCard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="overflow: auto; padding: 5px;">
                ...
                <asp:AccordionPane ID="AccordionPane1" runat="server">
                    ...
                    <Content>
                        <asp:Panel ID="PanelSearch3" runat="server">
                            <fieldset style="border: 1px solid #FDBF12; width: 70%">
                                <div class="titleSub3">
                                ...
                                <div style="clear: both; margin: 1px;">
                                    ...
                                    <div style="padding-top: 5px;">
                                        ...
                                        <div style="padding-top: 5px;">
                                            <asp:GridView ID="grvBINCard" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333"
                                                GridLines="None" PageSize="5" AutoGenerateColumns="False" DataKeyNames="ID" OnPageIndexChanging="grvBINCard_PageIndexChanging"
                                                OnSelectedIndexChanged="grvBINCard_SelectedIndexChanged">
                                                <EmptyDataTemplate>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Min.Qty">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblMinOrderQuantity" Text='<%# Eval("MinOrderQuantity") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="ShelfNo">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblShelfNo" Text='<%# Eval("ShelfNo") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="RankNo">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRankNo" Text='<%# Eval("RankNo") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
        ...
        <div class="titleSub2" style="width: 59%">
            <asp:Label ID="Label4" runat="server" Text="BIN Card"></asp:Label></div>
        <div id="MainForm" style="width: 60%">
            <div>
                <div id="Div4" class="form2" style="width: 90%">
                    <%--   --%>
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        <div class="leftControl">
                            <asp:Label ID="Label8" runat="server" Text="Begining Quantity"></asp:Label>
                        </div>
                        <div class="rightControl">
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        <div class="leftControl">
                            <asp:Label ID="Label13" runat="server" Text="Minimum Order Quantity"></asp:Label>
                        </div>
                        <div class="rightControl">
                            <asp:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" runat="server" Enabled="True"
                                TargetControlID="Cv1">
                            </asp:ValidatorCalloutExtender>
                            <asp:TextBox ID="txtMinOrderQuantity" runat="server" ValidationGroup="save">
                            </asp:TextBox>
                            <asp:RequiredFieldValidator ID="txtUnitPriceValidator6" runat="server" ControlToValidate="txtMinOrderQuantity"
                                Display="Dynamic" ErrorMessage="*" ForeColor="#CC3300" ValidationGroup="save">
                            </asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="Cv2" runat="server" ControlToValidate="txtMinOrderQuantity"
                                Display="None" ErrorMessage="Please enter numbers only." ForeColor="#CC3300"
                                Operator="DataTypeCheck" Type="Double" ValidationGroup="save"></asp:CompareValidator>
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        <div class="leftControl">
                            <asp:Label ID="Label19" runat="server" Text="Shelf No"></asp:Label>
                        </div>
                        <div class="rightControl">
                            <asp:TextBox ID="txtShelfNo" runat="server" ValidationGroup="save">
                            </asp:TextBox>
                        </div>
                    </div>
                    <%--  --%>
                    <div class="controlContainer" style="margin-top: 10px">
                        <div class="leftControl">
                            <asp:Label ID="Label20" runat="server" Text="Rank No"></asp:Label>
                        </div>
                        <div class="rightControl">
                            <asp:TextBox ID="txtRankNo" runat="server" ValidationGroup="save">
                            </asp:TextBox>
                        </div>
                    </div>
                    <%--  --%>
