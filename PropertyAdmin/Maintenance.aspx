<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Maintenance.aspx.cs" Inherits="PropertyAdmin.Maintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="overflow: auto; padding: 5px;">
        ...
        <%--   <asp:HyperLinkField DataNavigateUrlFields="ID" 
                                DataNavigateUrlFormatString="TFAB.aspx?FAID={0}" DataTextField="FARNNo" 
                                HeaderText="TFAB" NavigateUrl="~/TFAB.aspx" />--%>
                ...
                <div id="RightForm" class="form2">
                    <div class="controlContainer" style="margin-top: 10px; height: 50px;">
                        ...
                        <div class="rightControl">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSNo"
                                Display="Dynamic" ErrorMessage="*" ForeColor="#CC3300" ValidationGroup="save"> </asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <%-- --%>
