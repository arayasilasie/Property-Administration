<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="StoreIssueVoucher.aspx.cs" Inherits="PropertyAdmin.StoreIssueVoucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="overflow: auto; padding: 5px;">
                            ...
                            <fieldset style="border: 1px solid #FDBF12;">
                                ...
                                <div style="clear: both; margin: 1px;">
                                    ...
                                    <div style="padding-top: 5px;">
                                        ...
                                        <div style="padding-top: 5px;">
                                            <asp:GridView ID="grvSIV" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333"
                                                GridLines="None" PageSize="5" AutoGenerateColumns="False" DataKeyNames="ID" OnSelectedIndexChanged="grvSIV_SelectedIndexChanged"
                                                OnPageIndexChanging="grvSIV_PageIndexChanging" OnRowDataBound="grvSIV_RowDataBound">
                                                <EmptyDataTemplate>
                                                ...
                                                <Columns>
                                                   ...
                                                   <%-- <asp:HyperLinkField DataNavigateUrlFields="ID" HeaderText="RMRN" DataNavigateUrlFormatString="RMRN.aspx?SIVID={0}"
                                                        DataTextField="SIVNo" NavigateUrl="~/RMRN.aspx" />--%>
                                                </Columns>
        ...
        <div class="titleSub2">
            <asp:Label ID="lblHeader" runat="server" Text="Store Issue Voucher"></asp:Label></div>
        <div id="MainForm">
            <div>
                <div id="LeftForm" class="form2">
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        <div class="leftControl">
                            <asp:Label ID="Label17" runat="server" Text="SIVNo"></asp:Label>
                        </div>
                        <div class="rightControl">
                            <asp:TextBox ID="txtSIVNo" runat="server" ValidationGroup="save">
                            </asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSIVNo"
                                Display="Dynamic" ErrorMessage="*" ForeColor="#CC3300" ValidationGroup="save"></asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CVs" runat="server" ControlToValidate="txtSIVNo" Display="None"
                    ...
                    <div class="controlContainer" style="margin-top: 10px">
                        ...
                        <div class="rightControl">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                ControlToValidate="txtReqQuantity" Display="Dynamic" ErrorMessage="*" 
                                ForeColor="#CC3300" ValidationGroup="save">
                            </asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="Cv1" runat="server" 
                                ControlToValidate="txtReqQuantity" Display="None" 
                                ErrorMessage="Please enter numbers only." ForeColor="#CC3300" 
                                Operator="DataTypeCheck" Type="Double" ValidationGroup="save"></asp:CompareValidator>
                            <asp:ValidatorCalloutExtender ID="Cv1_ValidatorCalloutExtender" runat="server" 
                                Enabled="True" TargetControlID="Cv1">
                            </asp:ValidatorCalloutExtender>
                        </div>
                    </div>
                    <%--  --%>
